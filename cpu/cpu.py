...
class CPU():
    ...
    def pop(self, count:int=2) -> bytearray:
        ...
        :param self: The CPU object
        :param count: The amount of bytes to pop
        :type count: int
        :return: The data read
        :rtype: bytearray
        '''
        #FFR: do we need count? or should we remove that
        #is there a situation when we pop less or more than 2 bytes?
    ...
    def pop_int(self) -> int:
        '''
        Pops a 16 bit integer off of the stack
